            ...
            @else
                <div class="col-lg-12" style="margin-top: 20px">
                    <div class="d-flex align-items-start">
                        <div style="height: 500px;border: 2px solid red;" class="nav flex-column nav-pills me-3"
                             id="v-pills-tab" role="tablist"
                             aria-orientation="vertical">
                            <button class="nav-link active" style="width: 280px;" id="v-pills-home-tab"
                                    data-bs-toggle="pill"
...
{{--                            </button>--}}
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                ...
                                <div class="myaccount-orders" style="width: 100%;">
                                    <h4 class="small-title" style="margin: 10px;"> Accepted Requests </h4>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            <tbody>
                                            <tr>
