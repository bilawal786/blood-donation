            ...
            <div class="col-lg-12">
                <div class="d-flex align-items-start">
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                        ...
                        <button class="nav-link active" style="width: 280px;" id="v-pills-home-tab" data-bs-toggle="pill"
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <form method="POST"  style="padding: 90px!important;" action="{{route('user.update.profile')}}"
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="name" id="name" value="{{$user->name}}"
                                               placeholder="Full name" class="form--control" maxlength="80" required="">

                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="email">Email <sup class="text--danger">*</sup></label>
                                        <input type="email" name="email" id="email" readonly value="{{$user->email}}"
                                               placeholder="Enter Email" class="form--control" maxlength="60">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="phone">Phone <sup class="text--danger">*</sup></label>
                                        <input type="text" name="phone" id="phone" value="{{$user->phone}}"
                                               placeholder="Enter Phone" class="form--control" maxlength="40">
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="address" id="address" value="{{$user->address}}"
                                               placeholder="Enter Address" class="form--control" maxlength="255">
                                    </div>
                                    @if($user->role==2)
                                        <div class="form-group col-sm-6" id="dob">
                                            <label for="date_birth">Date Of Birth <sup
                                                    class="text--danger">*</sup></label>
                                            <input type="date" id="date_birth" name="dob" value="{{$user->dob}}"
                                        ...
                                        <div class="form-group col-sm-6" id="s_time">
                                            <label for="religion"> Starting Time <sup
                                                    class="text--danger">*</sup></label>
                                            <input type="time" name="s_time" id="s_time" value="{{$user->s_time}}"
                                                   class="form--control">
                                        </div>
                                        <div class="form-group col-sm-6" id="e_time">
                                            <label for="religion"> Ending Time Time <sup
                                                    class="text--danger">*</sup></label>
                                            <input type="time" name="e_time" id="e_time" value="{{$user->e_time}}"
                                                   class="form--control">
                                        </div>
                                    ...
                                    <div class="form-group col-sm-6" id="weight">
                                        ...
                                        <input type="password" name="password" id="password" value="" data-language="en"
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea name="about" id="about_details" placeholder="Enter Details"
