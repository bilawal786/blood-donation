...
@section('content')
    <section class="pt-100 pb-100 position-relative z-index section--bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form method="POST" action="{{route('register')}}" class="contact-form bg-white p-sm-5 p-3 rounded-3 position-relative" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="form-group col-lg-6">
                                <label for="role">Your Role <sup class="text--danger">*</sup></label>
                                <select name="role" id="role" class="form--control" required="">
                                    <option value="" >Select One Role</option>
                                    <option value="1">Donee</option>
